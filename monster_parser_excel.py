...
! Familiar
| colspan='3' style='border-left-style: none; background-color: #E2F3FF; text-align: center;' | [[File:{familiars_img[row['familiar']-1]}.png|center|50x50px]][[Magical Familiar|Magical Familiar #{row['familiar']}]]
<!-- ========== END: Monster Row ========== -->
